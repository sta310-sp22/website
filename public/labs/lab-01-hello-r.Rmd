...
-   The "Workflow & formatting" grade is to assess the reproducible workflow.t This includes having at least 3 informative commit messages, labeling the code chunks, and updating the name and date in the YAML.
