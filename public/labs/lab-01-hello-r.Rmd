...
::: {.commit}
`r emo::ji("yarn")` `r emo::ji("white_check_mark")` `r emo::ji("arrow_up")`nit, commit, and push your changes to GitHub with the commit message "Added answer for Ex 1".
...
-   The "Overall" grade is to assess the reproducible workflow.t This includes having at least 3 informative commit messages, labeling the code chunks, and updating the name and date in the YAML.
