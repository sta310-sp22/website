---
title: "Inference using the Central Limit Thereom"
...
durham %>% 
  ...
  ggplot(aes(x = quality_library)) + 
    ...
    labs(x = "Satisfaction with public library system", y = "Count",
         title = "Most residents are generally satisifed <br> with the public library system")
```
]
...
mean? This is our test statistic, $T$. 
]
