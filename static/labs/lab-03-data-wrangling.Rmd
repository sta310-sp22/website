...
6. *Are newer or older Avengers more popular?* Calculate the mean number of appearances for each introduction year (`year`). Then create a scatterplot of the mean appearances by introduction year. Do **not** include the introduction year 1900. 
