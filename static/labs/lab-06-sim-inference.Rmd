...
`durham-survey-2020.csv` contains data from over 800 Durham residents on a variety of survey questions. Assume that the data are representative of
...
-   Use a small number of reps (about 100) as you write and test out
    ...
    number of reps to 10,000 to produce your final results. final
    results.
