...
2. We can see which states have the most progressive and most moderate Democratic delegations. Find the mean ideology by state and display the most progressive two states and most moderate two states. The ideology is measured by `nominate_dim`. Show all code and output. 
...
5. Now let's look at the caucus. Calculate the mean and standard deviation of ideology and the number of representatives for each caucus.
  ...
  - Which caucus has the most variability in the ideology?
