...
subtitle: 'due Wed, Oct 15 11:59pm'
output: 
  tufte::tufte_html:
    css: "sta199-hw.css"
...
- Go to the [ORG](ADD LINK) organization on GitHub. Click on the repo with the prefix hw-03. It contains the starter documents you need to complete the assignment.

- Clone the repo and start a new project in RStudio. See the [Lab 01 instructions](ADD LINK) for details on cloning a repo and starting a new R project.
